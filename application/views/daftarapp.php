          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div id="message">
                  <?php 
                    if($this->session->flashdata('messagemode','messagetext','messageactive') && $this->session->flashdata('messageactive') == "indexapp"){
...
$('#btnDelteYes').click(function () {
    ...
    window.location.href = '<?php echo base_url();?>index.php/app/hapus/'+id;
});
</script>