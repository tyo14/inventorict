          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div id="message">
                  <?php 
                    if($this->session->flashdata('messagemode','messagetext','messageactive') && $this->session->flashdata('messageactive') == "indexdevisi"){
...
$('#btnDelteYes').click(function () {
    ...
    window.location.href = '<?php echo base_url();?>index.php/devisi/hapus/'+id;
});
</script>