          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div id="message">
                  <?php 
                    if($this->session->flashdata('messagemode','messagetext','messageactive') && $this->session->flashdata('messageactive') == "indexkategori"){
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                    <tr class="btnDelete" data-id="<?php echo $kategoridata['kode_kategori'];?>">
                      <td><?php echo $kategoridata['kode_kategori'];?></td>
                      <td><?php echo $kategoridata['nama_kategori'];?></td>
                      <td><?php echo $divisi['nama_divisi'];?></td>
                      <td class="text-center">
                      <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>index.php/kategori/ubah/<?php echo $kategoridata['kode_kategori'];?>" data-placement="top" data-toggle="tooltip" title="Ubah"><span class="glyphicon glyphicon-pencil"></span></a>
...
$('#btnDelteYes').click(function () {
    ...
    window.location.href = '<?php echo base_url();?>index.php/kategori/hapus/'+id;
});
