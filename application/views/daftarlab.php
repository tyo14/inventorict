              ...
              <div class="box box-primary">
                ...
                <div id="message"></div>
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr class="btnDelete" data-id="<?php echo $fetchdata['kode_lab'];?>">
                        <td><?php echo $fetchdata['kode_lab']; ?></td>
                        <td><?php echo $fetchdata['nama_lab']; ?></td>
                        <td class="text-center">
                        <a class="btn btn-primary btn-xs" href="<?php echo base_url();?>index.php/lab/ubah/<?php echo $fetchdata['kode_lab'];?>" data-placement="top" data-toggle="tooltip" title="Ubah"><span class="glyphicon glyphicon-pencil"></span></a>
