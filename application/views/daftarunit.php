          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div id="message">
                  <?php 
                    if($this->session->flashdata('messagemode','messagetext','messageactive') && $this->session->flashdata('messageactive') == "indexunit"){
...
$('#btnDelteYes').click(function () {
    ...
    window.location.href = '<?php echo base_url();?>index.php/unit/hapus/'+id;
});
</script>