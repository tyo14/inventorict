<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Form Workgroup
            <small>Ubah Data Workgroup</small>
          </h1><br>
          <p>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div id="message">
                <?php 
                    if($this->session->flashdata('messagemode','messagetext','messageactive') && $this->session->flashdata('messageactive') == "ubahlab"){
              ...
              <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_lab" class="form-control" id="kode" placeholder="Kode Workgroup" maxlength="10" 
                    value="<?php list($kode,$digit) = explode('-', $lab['kode_lab']); echo $digit;?>" 
                    onkeypress="return isNumberKey(event)"  required>
                </div>
                <div class="form-group">
                    <label for="inputNamaDevisi">Nama Workgroup</label>
                    <input type="text" name="nama_lab" class="form-control" placeholder="Nama Workgroup" value="<?php echo $lab['nama_lab'];?>" required>
                </div>
            </div><!-- /.box-body -->
