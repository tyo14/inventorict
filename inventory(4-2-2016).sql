...
--
-- Host: localhost
-- Generation Time: Feb 04, 2016 at 11:13 AM
...
--
-- Table structure for table `rakitan_setting`
--

CREATE TABLE `rakitan_setting` (
  `id` int(11) NOT NULL,
  `spek` varchar(50) NOT NULL,
  `sup_device` varchar(50) NOT NULL,
  `os` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `rakitan_setting`
--

INSERT INTO `rakitan_setting` (`id`, `spek`, `sup_device`, `os`) VALUES
(1, 'HWR-001', 'HWR-002', 'STR-001');
...
--
-- Indexes for table `rakitan_setting`
--
ALTER TABLE `rakitan_setting`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `rakitan_setting`
--
ALTER TABLE `rakitan_setting`
